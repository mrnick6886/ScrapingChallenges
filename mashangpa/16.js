...
const getDataH5 = async(page, time) => {
    return PcSign.sign(
        {page: page, t: time}
    )
}
...
const getPage = async(page) => {
    ...
    const h5String = await getDataH5(page, timestamp)

    const response = await fetch(`https://www.mashangpa.com/api/problem-detail/16/data/`, {
        "headers": {
            "accept": "*/*",
