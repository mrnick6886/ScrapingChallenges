_ajax = {
    ...
    extend: function(){
        window.__12__url = arguments[2]['url']
    },
    toString: function(){
        console.log(`call toString 333`, arguments)
    }
}
    ...
    while (QQ0OQOQ['SVHwt'](O00000O, QQ0OQOO['length'])) {
        ...
        if (QQ0OQOQ[OQQQ00Q(0x2e8, 'ppvG')](OQO00OO, 0x2)) {
            if (QQ0OQOQ[OQQQ00Q(0x292, 'G7LQ')](QQ0OQOQ[OQQQ00Q(0x25c, 'Qwom')], QQ0OQOQ[OQQQ00Q(0x2b6, '03K!')])) {
                ...
                //     ? QQ0OQOQ[OQQQ00Q(0x20b, 'xTCl')](QQ0OQOQ[OQQQ00Q(0x2d2, 'BH%f')], QQ0OQOQ['OKOJD'])
                //         ? OOQQQQQ = QOQ0Q0O[OQQQ00Q(0x2c1, 'pGfn')](QQ0OQ0Q, QQ0O0Q0)
                //         : QQQ0OQO = Q0OQO0O['apply'](OQ000OQ, QQO0OQ0)
                //     : QQQ0OQO = QQQ0OQQ[Q0OQO0O][OQQQ00Q(0x225, '[Vwq')](QQQ0OQQ, QQO0OQ0);

                if(QQ0OQOQ['pmYDI'](QQQ0OQQ, 0x0)){
                    QQQ0OQO = Q0OQO0O['apply'](OQ000OQ, QQO0OQ0)
                }else{
                    QQQ0OQO = QQQ0OQQ[Q0OQO0O]['apply'](QQQ0OQQ, QQO0OQ0);
                }
...
function getUrl(page) {
    ...
    return window.__12__url;
}


const getPage = async(page) => {
    const url = `https://www.mashangpa.com` + getUrl(page)
